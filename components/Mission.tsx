      ...
      <div className="container-page">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {values.map((value) => (
            <div
              key={value.title}
              className="group rounded-3xl border border-ink-100 bg-white p-8 shadow-soft transition-all duration-300 hover:-translate-y-1 hover:border-flame-200"
            >
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-flame-50 text-flame-600 transition-colors group-hover:bg-flame-500 group-hover:text-white">
                <svg
                  width="26"
                  height="26"
                  viewBox="0 0 24 24"
