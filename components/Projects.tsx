      ...
      <div className="container-page">
        ...
        <div className="mt-14 grid gap-px overflow-hidden rounded-3xl border border-ink-100 bg-ink-100 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, i) => (
            <div
              key={project.name}
              className="group relative bg-white p-8 transition-colors hover:bg-grape-50"
            >
              <span className="text-5xl font-black text-ink-100 transition-colors group-hover:text-grape-200">
          ...
          <div className="flex flex-col justify-center bg-ink-900 p-8 text-white">
            ...
            <a href="#iletisim" className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-leaf-300 hover:text-leaf-200">
              İletişime geç
