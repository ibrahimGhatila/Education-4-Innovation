 ...
 * Tower, Amsterdam gables).
 *
 * A brand-colour shimmer (purple → maroon → orange → green) drifts across
 * the skyline, masked to the silhouette so the colours only ever glow
 * inside the city shape. Two bands move at different speeds/directions for
 * an organic, ever-shifting flow.
 */
  ...
  return (
    ...
    >
      <defs>
        ...
        {/* Drifting brand-colour shimmer bands */}
        <linearGradient id="skyShimmerA" x1="0" y1="0" x2="600" y2="0" gradientUnits="userSpaceOnUse" spreadMethod="repeat">
          <stop offset="0.00" stopColor="#6F2AA4" stopOpacity="0" />
          <stop offset="0.10" stopColor="#6F2AA4" stopOpacity="0.85" />
          <stop offset="0.22" stopColor="#8A1E3C" stopOpacity="0.8" />
          <stop offset="0.34" stopColor="#FB7F0D" stopOpacity="0.9" />
          <stop offset="0.46" stopColor="#7BD32C" stopOpacity="0.8" />
          <stop offset="0.60" stopColor="#6F2AA4" stopOpacity="0" />
        ...
        <linearGradient id="skyShimmerB" x1="0" y1="0" x2="820" y2="0" gradientUnits="userSpaceOnUse" spreadMethod="repeat">
          <stop offset="0.00" stopColor="#FB7F0D" stopOpacity="0" />
          <stop offset="0.14" stopColor="#FB7F0D" stopOpacity="0.7" />
          <stop offset="0.30" stopColor="#7BD32C" stopOpacity="0.65" />
          <stop offset="0.46" stopColor="#6F2AA4" stopOpacity="0.7" />
          <stop offset="0.62" stopColor="#FB7F0D" stopOpacity="0" />
          <stop offset="1.00" stopColor="#FB7F0D" stopOpacity="0" />
          <animateTransform attributeName="gradientTransform" type="translate" from="0 0" to="-820 0" dur="15s" repeatCount="indefinite" />
        </linearGradient>
      ...
      {/* Shimmer — brand colours drifting, clipped to the skyline */}
      <g mask="url(#cityMask)">
        <rect x="0" y="0" width="1440" height="300" fill="url(#skyShimmerA)" opacity="0.85" />
        <rect x="0" y="0" width="1440" height="300" fill="url(#skyShimmerB)" opacity="0.6" />
      </g>
