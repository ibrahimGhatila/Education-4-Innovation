      ...
      <div className="container-page">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {posts.map((post) => (
            ...
            >
              <div className="bg-mesh flex aspect-[16/10] items-center justify-center bg-grape-50">
                <svg width="44" height="44" viewBox="0 0 48 48" fill="none" aria-hidden="true" className="opacity-90">
                  <path d="M26.5 3.2c1.3 6.1-1.7 9.7-5.1 13.1-3.6 3.6-7.7 7.2-7.7 14.1C13.7 39 19.4 45 26.2 45c7 0 12.4-5.3 12.4-12.7 0-4.9-2.4-8.9-4.7-12-.3 2.6-1.7 4.3-3.3 4.3-1.8 0-2.6-1.4-2.6-3.9 0-5.6 1.3-11.4-1.5-17.5Z" fill="#FB7F0D" />
                </svg>
              </div>
              <div className="flex flex-1 flex-col p-6">
                <div className="flex items-center gap-3 text-xs font-semibold uppercase tracking-wider text-leaf-700">
